...
# python ./tools/infer.py ../../data/misc/nuhtc_demo/imgs configs/nuhtc/htc_lite_swin_pytorch_fpn_PanNuke_seasaw_CAS.py ../../artifacts/models/third_party/nuhtc/pannuke.pth --out ../../artifacts/runs/nuhtc_demo/images
def parse_args():
