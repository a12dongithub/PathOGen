...
The fidelity results enable a compact downstream protocol. This section specifies the endpoints without inserting unmeasured projected values into the reviewer manuscript. Table~\ref{tab:xai_all_tasks} reserves the paired model-sensitivity and explanation-faithfulness results.
