...
def train_balanced_mlp_classifier(uni_model, uni_transform, device):
    ...
    # Clean patient level train/test split
...
def main():
    ...
    print(f"Starting 100-Grid Probe (Balanced MLP) on {len(target_files)} target tiles...")
    ...
    output_csv = OUTPUT_DIR / "large_scale_balanced_probe_results.csv"
