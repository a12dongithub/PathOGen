...
The workspace is about 191 GB. Source, data, artifacts, reports, and archives are now separated, but the two full snapshots and extracted copies still occupy the same filesystem. This continues to affect backup and retention.
