...
def main():
    ...
    csv_path = os.path.join(METRICS_DIR, "forward_prop_audit_results.csv")
    ...
    plt.title('Synthetic Spatial-Token Injection: Downstream Preservation\n(Predicting UNI-2h Intermediate Layers from Morphology)', fontsize=16, fontweight='bold', pad=15)
    ...
    out_path = os.path.join(FIGURES_DIR, "forward_prop_audit_plot.png")
