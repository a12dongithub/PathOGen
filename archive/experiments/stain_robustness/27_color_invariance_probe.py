...
def main():
    ...
    output_path = Path("artifacts/runs/stain_robustness/metrics/color_invariance_results.csv")
    ...
    print(f"UNI-2h Color Invariance: {inv_uni:.1f}%")
    print(f"CTransPath Color Invariance: {inv_ctr:.1f}%")
    print(f"ResNet50 Color Invariance: {inv_res:.1f}%")
    print("=============================")
