...
import nuhtc.models  # Register custom models
...
# python ./tools/infer_wsi.py ../../data/misc/nuhtc_demo/wsi configs/nuhtc/htc_lite_swin_pytorch_fpn_PanNuke_seasaw_CAS.py ../../artifacts/models/third_party/nuhtc/pannuke.pth --patch --seg --stitch --patch_size 256 --step_size 224 --save_dir ../../artifacts/runs/nuhtc_demo/wsi --det
def parse_args():
...
def main():
    ...
    for bag_candidate_idx in range(total):
        ...
        dataset = Whole_Slide_Bag_FP(file_path=h5_file_path, wsi_path=slide_file_path, 
