...
# Monkey-patch eigvals for CPU fallback (same as inference.py)
...
gen_dir = Path("artifacts/runs/legacy_phase2_checkpoint_comparison/ckpt_b")
real_dir = Path("data/interim/tiles/tcga_brca")
